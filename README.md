...
[![Tests](https://img.shields.io/badge/tests-97%20passing-brightgreen.svg)](#测试)
...
tests/
  ...
  review_fixes_test.cjs       33 项（一轮外部代码评审的发现）
...
node tests/review_fixes_test.cjs # 通过 33，失败 0
